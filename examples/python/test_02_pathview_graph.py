...
Generated by pvm2py on 2026-02-18 14:06:08
...
alpha__fbigdelta_textcmdetbig = DynamicalFunction(
    f_aircraft
)
...
connections = [
    ...
    Connection(amplifier_times_100[0], scope[1]),
    Connection(alpha__fbigdelta_textcmdetbig[0], scope[0]),
]
